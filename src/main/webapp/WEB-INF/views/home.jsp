   ...
   <div class="container">
        <div class="mt-4" align="center">
         <h4>${ successMessage }</h4>
          <h5> Click <a href="/list"><b>here</b></a> to see your product list!</h5>
           <h3>Our Products Categories</h3>
        </div>
        <h4 align="left"><a href="/new-category" class="btn btn-success">Add New Category</a></h4>
                ...
                <div class="card mb-0">
                    <div class="project m-0">
                        <figure class="portfolio-item">
                            <a href="/detail-category?id=${ category.id }" class="hovereffect">
                                <img class="img-responsive" src="${ category.imageUrl }" title="${ category.name }" alt="">
                            </a>
                        </figure>
                    </div>
                </div>
