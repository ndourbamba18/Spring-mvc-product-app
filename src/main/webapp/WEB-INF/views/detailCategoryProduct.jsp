    ...
    <div class="row mt-5">
        <div class="col-md-5">
            <div class="project-info-box mt-0">
                <h5>DETAILS PRODUCT OF <b>${ category.name }</b> </h5>
        ...
        <div class="col-md-7">
            <img style="cursor: pointer;" src="${ category.imageUrl }" title="${ category.name }" alt="project-image" class="rounded">
            <div class="project-info-box">
                <p><b>Categories:</b> Lap Top</p>
            </div>
            <div>
               <a href="/update-category?id=${ category.id }" class="btn btn-info">Edit</a>
               <a href="/dalete-category?id=${ category.id }" class="btn btn-danger">Delete</a>
