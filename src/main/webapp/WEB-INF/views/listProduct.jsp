...
<section>
   <div class="container">
        ...
        <h4 align="left">Your Product List</h4>
                ...
                <div class="card mb-0">
                    <div class="project m-0">
                        <figure class="portfolio-item">
                            <a href="/detail-product?id=${ product.id }" class="hovereffect">
                                <img h class="img-responsive" src="${ product.imageUrl }" title="${ product.name }" alt="">
                            </a>
                        </figure>
                    </div>
                </div>
