    ...
    <div class="row mt-5">
        <div class="col-md-5">
            <div class="project-info-box mt-0">
                <h5>DETAILS PRODUCT OF <b>${ product.name }</b> </h5>
                <p class="mb-0">${ product.description } </p>
                <p> Vivamus pellentesque, felis in aliquam ullamcorper, lorem tortor porttitor erat, hendrerit porta nunc tellus eu lectus. Ut vel imperdiet est. Pellentesque condimentum, dui et blandit laoreet, quam nisi tincidunt tortor.</p>
            </div>

            <div class="project-info-box">
                <p><b>Name:</b> ${ product.name }</p>
                <p><b>Brand:</b> ${ product.brand }</p>
                <p><b>Made In:</b> ${ product.madeIn }</p>
                <p><b>Is Stock:</b> ${ product.stock }</p>
                <p class="mb-0"><b>Price:</b> $ ${ product.price }</p> 
            </div>
        ...
        <div class="col-md-7">
            <img style="cursor: pointer;" src="${ product.imageUrl }" title="${ product.name }" alt="project-image" class="rounded">
            <div class="project-info-box">
                <p><b>Categories:</b> Lap Top</p>
            </div>
            <div>
               <a href="/list" class="btn btn-info">Back</a>
               <a href="/home" class="btn btn-success">Products Categories</a>
            </div>
        </div>
    </div>
</div>
